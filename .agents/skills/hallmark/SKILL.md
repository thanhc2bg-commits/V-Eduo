---
name: hallmark
description: Trigger this skill whenever the user asks to build new UI, audit frontend code, or redesign components. It applies Hallmark anti-slop rules.
---

# hallmark

IMPORTANT: All reference files and markdown documents mentioned below are located in the .cline/hallmark/skills/hallmark/references directory of this workspace. You must read them from there.
